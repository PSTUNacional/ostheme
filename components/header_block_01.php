    ...
    <div class="container">
        <div class="header-block-01">
            ...
            <div class="col col-25 middle">
                ...
                <article>
                    <h5 class="sup-category"><?= get_cat_name(wp_get_post_categories($posts[4]->ID)[0]); ?></h5>
                    <a href="<?= get_permalink($posts[4]->ID); ?>" title="<?= $posts[4]->post_title; ?>">
            ...
            <div class="col col-25">
                <?php
                $args = array('numberposts' => 1, 'category' => 50);
                $editorial = get_posts($args);
                ?>
                <article class="article-editorial">
                    <h5 class="badge primary">Editorial</h5>
                    <a class="featured-image-container" href="<?= get_permalink($editorial[0]->ID); ?>">
