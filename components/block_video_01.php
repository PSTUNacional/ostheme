    ...
    <div class="container">
        <div class="col">
            ...
            <div class="video-container">
                ...
                <div class="col">
                    <div target="_blank" href="https://www.youtube.com/watch?v=<?= $videos_arr[1]['video_id'] ?>" aria-label="Clique para assistir o vídeo" class="video-item" data-video="<?= $videos_arr[1]['video_id'] ?>">
